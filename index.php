...
<html lang="en">
  <head>
    ...
    <style>
        ...
        /* Additional styles for the "teams" section */
        .section-header {
            margin-bottom: 30px; /* Increase the margin between "Our Expertise" and the images */
        }
        #teams {
            text-align: center; /* Center the "Our Expertise" sentence */
            padding-top: 50px; /* Increase the gap between the images and the "Our Expertise" sentence */
            padding-bottom: 50px; /* Increase the gap between the images and the "Our Expertise" sentence */
        }

        .teams .row {
            justify-content: space-between; /* Distribute images with equal space between the first and last images and the margins */
        }

        .teams .col-md-2 {
            flex: 0 0 18%; /* Adjust the width of each image column to allow equal spacing */
        }
    </style>
...
<section id="teams" class="section teams">
    <div class="container">
        <div class="section-header">
            <h1 class="wow fadeInDown animated">Our Expertise</h1>
        </div>
        <div class="row">
            <div class="col-md-2 col-sm-6">
                <div class="person">
                    <img src="assets/images/t5.png" alt="" class="img-responsive">
                    <div class="person-content">
                        <h4>Nishani Haththelarachchi</h4>
                        <p>Founder</p>
                    </div>
                </div>
            </div>
            <div class="col-md-2 col-sm-6">
                <div class="person">
                    <img src="assets/images/t2.png" alt="" class="img-responsive">
                    <div class="person-content">
                        <h4>Pinidi Perere</h4>
                        <p>Stylist</p>
                    </div>
            ...
            <div class="col-md-2 col-sm-6">
                <div class="person">
                    <img src="assets/images/t3.png" alt="" class="img-responsive">
                    <div class="person-content">
                        <h4>Kalani de Silva</h4>
                        <p>Stylist</p>
                    </div>
                </div>
            </div>
            <div class="col-md-2 col-sm-6">
                <div class="person">
                    <img src="assets/images/t4.png" alt="" class="img-responsive">
                    <div class="person-content">
                        <h4>Nayumo Dias</h4>
                        <p>Colourist</p>
                    </div>
            ...
            <div class="col-md-2 col-sm-6">
                <div class="person">
                    <img src="assets/images/t1.png" alt="" class="img-responsive">
                    <div class="person-content">
                        <h4>Geethmi Perera</h4>
                        <p>Shampooist</p>
                    </div>
                </div>
            </div>
