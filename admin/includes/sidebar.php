  <div class=" sidebar" role="navigation">
        ...
        <li><a href="unreadenq.php">Unread Enquiry</a></li>
          ...
          <!-- Add Inventory Section to the Sidebar -->
      <li>
        <a href="#inventory" data-toggle="collapse"><i class="fa fa-list-alt nav_icon"></i>Inventory <span class="fa arrow"></span></a>
        <ul class="nav nav-second-level collapse" id="inventory">
